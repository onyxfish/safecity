...
* TODO: floodwatch: watches for for more than 5 consecutive text messages
* TODO: permaban: adds the ability for moderates to block numbers
...
* logger app should not record phone numbers
* need to gut and rewire the rapidsms logging system
h2. Bugs in RapidSMS
